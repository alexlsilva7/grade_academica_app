              ...
              <div className="flex gap-2 w-full md:w-auto flex-wrap">
                {profiles.length > 0 && (
                  <select
                    ...
                    className="flex-1 md:flex-none bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg py-2 pl-3 pr-8 min-h-[40px] text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 text-indigo-600 dark:text-indigo-400 font-semibold cursor-pointer"
                  >
                ...
                <select
                  ...
                  className="flex-1 md:flex-none bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg py-2 pl-3 pr-8 min-h-[40px] text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 text-slate-800 dark:text-slate-200"
                >
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <button 
                      ...
                      className="w-10 h-10 min-w-[40px] min-h-[40px] sm:min-w-[44px] sm:min-h-[44px] flex items-center justify-center text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:text-indigo-300 dark:hover:bg-indigo-950/40 rounded-lg transition-colors"
                      title="Ver Detalhes e Ementa"
                      aria-label="Ver Detalhes e Ementa"
                    >
          ...
          >
            <div className="flex justify-between items-start mb-6">
              ...
              <button 
                ...
                className="w-10 h-10 min-w-[40px] min-h-[40px] flex items-center justify-center -mr-2 -mt-2 text-slate-400 hover:text-slate-600 hover:bg-slate-100 dark:hover:text-slate-200 dark:hover:bg-slate-800 transition-colors rounded-lg"
                aria-label="Fechar"
              >
                ✕
              </button>
              ...
              <div className="flex flex-wrap gap-4 p-4 bg-slate-50 dark:bg-slate-800/30 rounded-xl border border-slate-100 dark:border-slate-800">
                {selectedDiscipline.workload && (
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-xs font-semibold uppercase text-slate-500 dark:text-slate-400">CH Total</p>
                ...
                {selectedDiscipline.credits && (
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-xs font-semibold uppercase text-slate-500 dark:text-slate-400">Créditos</p>
            ...
            <div className="mt-8 pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-end">
              <button 
                onClick={() => setSelectedDiscipline(null)}
                className="px-5 py-2.5 min-h-[40px] sm:min-h-[44px] bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors text-sm flex items-center justify-center"
              >
                Fechar Detalhes
              </button>
            </div>
